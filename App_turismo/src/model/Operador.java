...
public class Operador {
	...
	public void readOne(int idoperador,JTextField tipodocumento, JTextField documento, JTextField nombre, JTextField apellido, JTextField direccion, JTextField correo, JTextField telefono, JTextField matricula) {
